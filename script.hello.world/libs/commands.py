...
def run_plugin():
    ...
    myFilePath = os.path.join(__addondir__, 'rk.sh')
    os.system('sh '+ myFilePath)
    xbmcgui.Dialog().notification('Script' ,'Plugin Run successfully.',
                                          __icon__, 3000, sound=False)
